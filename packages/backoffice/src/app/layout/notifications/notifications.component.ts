...
export class Notifications implements OnInit {
  ...
  constructor(private el: ElementRef, private config: AppConfig, private userService: UserService) {
  ...
  ngOnInit(): void {
    this.config.onScreenSize(['sm', 'xs'], this.moveNotificationsDropdown, true);
